...
- (void)viewDidLoad {
    ...
    [button setTitle:@"AutoTag" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(buttonClick:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:button];
    {
        CGFloat left = 100;
        CGFloat top = CGRectGetMaxY(self.textView.frame)+100;
        CGFloat width = 100;
        CGFloat height = 100;
...
{
    AutoTagsViewController * vc = [AutoTagsViewController new];
